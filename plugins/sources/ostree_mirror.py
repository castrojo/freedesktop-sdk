...
class OSTreeMirrorSource(Source):
    ...
    def configure(self, node):
        node.validate_keys(
            ["match", "path", "url", "ref", "gpg"] + Source.COMMON_CONFIG_KEYS
        )
    ...
    def track(self):
        self.repo.pull("origin", None, OSTree.RepoPullFlags.MIRROR, None, None)
    ...
    def fetch(self):
        ...
        if to_fetch:
            self.repo.pull(
                "origin", [to_fetch], OSTree.RepoPullFlags.MIRROR, None, None
            )
